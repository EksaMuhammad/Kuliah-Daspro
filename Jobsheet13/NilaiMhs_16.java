...
public class NilaiMhs_16 {
    ...
    public static void main(String[] args) {
        ...
        hasilNilai();
        int indexMahasiswaTertinggi = searchMahasiswaTertinggi();
        showMahasiswaTertinggi(indexMahasiswaTertinggi);
    }
    ...
    static int searchMahasiswaTertinggi() {
    ...
    static void showMahasiswaTertinggi(int index) {
    ...
    static int searchMingguTerbaik() {
        int mingguTerbaik = 1;
        int maxNilai = 0;
